...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long hoursUnitlBoarding = TimeUnit.MINUTES.toHours(minutesUntilBoarding);
        long minutesLessHoursUntilBoarding = minutesUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUnitlBoarding);

        String hoursAndMinutesUnitlBoarding =
                getString(R.string.countDownFormat, hoursUnitlBoarding, minutesLessHoursUntilBoarding);

        mBinding.textViewBoardingInCountdown.setText(hoursAndMinutesUnitlBoarding);
