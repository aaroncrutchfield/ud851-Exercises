...
public class NotificationUtils {
    ...
    private static final int IGNORE_PENDING_INTENT_ID = 299;
    private static final int DRINK_WATER_PENDING_INTENT_ID = 89072;
    ...
    public static void remindUserBecauseCharging(Context context) {
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .addAction(ignoreRemidnerAction(context))
                .setAutoCancel(true);
    ...
    public static Action ignoreRemidnerAction(Context context){
