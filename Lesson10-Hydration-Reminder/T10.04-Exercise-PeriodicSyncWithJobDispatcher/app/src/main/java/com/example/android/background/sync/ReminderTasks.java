...
public class ReminderTasks {
    ...
    public static final String ACTION_INCREMENT_CHARGING_REMINDER_COUNT = "increment-charging-reminder-count";

    public static void executeTask(Context context, String action) {
        if (ACTION_INCREMENT_WATER_COUNT.equals(action)) {
            incrementWaterCount(context);
        } else if (ACTION_INCREMENT_CHARGING_REMINDER_COUNT.equals(action)){
