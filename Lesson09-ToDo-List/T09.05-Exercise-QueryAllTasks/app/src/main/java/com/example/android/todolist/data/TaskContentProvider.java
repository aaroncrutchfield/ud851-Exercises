...
public class TaskContentProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Cursor allTasksCursor = null;

        // TODO (3) Query for the tasks directory and write a default case
        switch (match){
            case TASKS:
                allTasksCursor = db.query(TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
        ...
        allTasksCursor.setNotificationUri(getContext().getContentResolver(), uri);

        return allTasksCursor;
    }
